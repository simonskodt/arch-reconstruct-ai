...
from src.mcp.utils.utils_configurations import BEARER_REGEX, ENVIRONMENT_VARIABLE_REGEX
...
class ConfigSanitizer:
    ...
    def __init__(self):
        ...
        self._bearer_regex = BEARER_REGEX
    ...
    def _is_secret_key(self, key: str, value: Optional[str]) -> bool:
        ...
        if isinstance(value, str):
            match = ENVIRONMENT_VARIABLE_REGEX.search(value)
