...
This is taken from a repository from LangChain, found under the following url:
https://github.com/langchain-ai/how_to_fix_your_context/blob/main/notebooks/utils.py
"""
...
def format_retriever_results(result, title="Retriever Tool Results"):
    ...
    for i, doc in enumerate(result):
        ...
        if hasattr(doc, 'metadata'):
            formatted_console.print("[cyan]Source:[/cyan] {doc.metadata.get('source', 'Unknown')}")
